...
export default function Usuario() {
  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-20 px-6 bg-gray-900">
      ...
      <div
        className={`p-6 max-w-md mx-auto  rounded-lg shadow-md transition-colors duration-500  hover:-translate-y-1 ${
          modoOscuro ? "bg-gray-800 text-gray-100" : "bg-white text-gray-900"
        }`}
      >
